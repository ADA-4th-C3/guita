  ...
  init() {
    let steps: [TechniqueStep] = [
      TechniqueStep(
        ...
        imageName: "",
        effectName: nil,
        subSteps: [TechniqueSubStep(ttsText: "주법은 기타를 치는 방법을 말합니다. 피크나 손가락으로 줄을 위아래로 튕기는 주법인 스트로크를 배워봅시다.", mp3FileName: nil)
                ]
      ),
      TechniqueStep(
        step: 2,
        ...
        imageName: "",
        effectName: nil,
        subSteps: [TechniqueSubStep(ttsText: "기타 몸통에 있는 구멍을 찾아보세요. 이 구멍을 사운드 홀이라고 부릅니다.위에서 아래로 줄을 쓸어내려 보세요.", mp3FileName: nil),
                   TechniqueSubStep(ttsText: nil, mp3FileName: "downSound"),
                   TechniqueSubStep(ttsText: "이것을 다운이라고 해요. 이제 반대로 아래에서 위로 쓸어올려 볼게요.", mp3FileName: "upSound"),
                   TechniqueSubStep(ttsText: "이것을 업이라고 해요. 자유롭게 업 다운 스트로크를 연주해보세요.", mp3FileName: nil)
      ...
      TechniqueStep(
        ...
        effectName: nil,
        subSteps: [TechniqueSubStep(ttsText: "가장 많이 사용하는 칼립소 주법을 알려줄게요. 칼립소 주법은 ", mp3FileName: "Calypso"),
                   TechniqueSubStep(ttsText: "순서대로 진행됩니다. 기타를 연주하면", mp3FileName: "Calypso"),
                   TechniqueSubStep(ttsText: "이렇게 들립니다. 반복해서 칼립소 주법을 연주해 보세요.", mp3FileName: nil)
      ...
      TechniqueStep(
        ...
        imageName: "",
        effectName: nil,
        subSteps: [TechniqueSubStep(ttsText: "주법 학습이 완료되었습니다. ", mp3FileName: nil),
                ]),
    ]
