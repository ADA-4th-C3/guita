...
enum Chord: String, CaseIterable, CustomStringConvertible {
  ...
  var coordinates: [([(fret: Int, string: Int)], finger: Int)] {
    ...
    case .Fm7: return [([(1, 1), (1, 2), (1, 3), (1, 6)], 2), ([(3, 5)], 4)]
    ...
    case .EM7: return [([(1, 3)], 2), ([(1, 4)], 3), ([(2, 5)], 4)]
    case .FM7: return [([(1, 2)], 2), ([(2, 3)], 3), ([(3, 4)], 4)]
    case .GM7: return [([(3, 6)], 3), ([(2, 2)], 2)]
    case .AM7: return [([(2, 4)], 3), ([(2, 2)], 4), ([(1, 3)], 2)]
    case .BM7: return [([(2, 1), (2, 2), (2, 5)], 2), ([(4, 4)], 4), ([(4, 2)], 3), ([(3, 3)], 5)]
    }
  }
