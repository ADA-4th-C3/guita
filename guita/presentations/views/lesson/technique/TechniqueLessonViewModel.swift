  ...
  init() {
    let steps: [TechniqueLessonStep] = [
      ...
      TechniqueLessonStep(
        ...
        imageName: "",
        subSteps: [TechniqueLessonSubStep(ttsText: NSLocalizedString("사운드 홀에 오른쪽 손을 두고, 위에서 아래로 줄을 쓸어내려 보세요.", comment:""), audioFile: .stroke_up, delayAfter: nil, speechRate: nil),
                   TechniqueLessonSubStep(ttsText: NSLocalizedString("이것을 업 스트로크라고 해요. 자유롭게 업 스트로크를 연주해보세요.",comment:""), audioFile: nil, delayAfter: nil, speechRate: nil)],
        featureDescription: NSLocalizedString("이전 학습으로 넘어가시려면 \"이전\", 다음 학습으로 넘어가시려면 \"다음\"을, 다시 들으시려면 \"다시\"를 말씀해 주세요.", comment:"")),
      TechniqueLessonStep(
        step: 4,
        totalSteps: 7,
        ...
        imageName: "",
        subSteps: [TechniqueLessonSubStep(ttsText: NSLocalizedString("사운드 홀에 오른쪽 손을 두고, 아래에서 위로 줄을 쓸어내려 보세요.", comment:""), audioFile: .stroke_down, delayAfter: nil, speechRate: nil),
                   TechniqueLessonSubStep(ttsText: NSLocalizedString("이것을 다운 스트로크라고 해요. 자유롭게 다운 스트로크를 연주해보세요.", comment: ""), audioFile: nil, delayAfter: nil, speechRate: nil)],
        featureDescription: NSLocalizedString("이전 학습으로 넘어가시려면 \"이전\", 다음 학습으로 넘어가시려면 \"다음\"을, 다시 들으시려면 \"다시\"를 말씀해 주세요.",comment:"")
      ),
