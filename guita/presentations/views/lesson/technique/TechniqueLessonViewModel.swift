  ...
  init() {
    let steps: [TechniqueLessonStep] = [
      TechniqueLessonStep(
        ...
        imageName: "",
        subSteps: [TechniqueLessonSubStep(ttsText: "주법은 기타를 치는 방법을 말합니다. 피크나 손가락으로 줄을 위아래로 튕기는 주법인 스트로크를 배워봅시다.", audioFile: nil, delayAfter: nil, speechRate: nil)],
        featureDescription: "다음 학습으로 넘어가시려면 \"다음\"을, 다시 들으시려면 \"다시\"를 말씀해 주세요."
      ),
      TechniqueLessonStep(
        step: 2,
        totalSteps: 7,
        description: "기타의 사운드 홀에 대한 설명",
        imageName: "",
        subSteps: [TechniqueLessonSubStep(ttsText: "기타 몸통에 있는 구멍을 찾아보세요. 이 구멍을 사운드 홀이라고 부릅니다.", audioFile: nil, delayAfter: nil, speechRate: nil)],
      ...
      TechniqueLessonStep(
        step: 5,
        totalSteps: 7,
        description: "칼립소 주법에 리듬에 대한 설명",
        imageName: "audio-file",
        subSteps: [TechniqueLessonSubStep(ttsText: "가장 많이 사용하는 칼립소 주법을 알려줄게요.", audioFile: nil, delayAfter: nil, speechRate: nil),
                   ...
                   TechniqueLessonSubStep(ttsText: "따라서 말해보며 리듬을 익혀보세요.", audioFile: nil, delayAfter: nil, speechRate: nil)],
        featureDescription: "이전 학습으로 넘어가시려면 \"이전\", 다음 학습으로 넘어가시려면 \"다음\"을, 다시 들으시려면 \"다시\"를 말씀해 주세요."
      ),
      TechniqueLessonStep(
        step: 6,
        ...
        imageName: "audio-file",
        subSteps: [TechniqueLessonSubStep(ttsText: "칼립소 주법을 기타로 연주하면 ", audioFile: .stroke_calipso, delayAfter: nil, speechRate: nil),
                   TechniqueLessonSubStep(ttsText: "이렇게 들립니다. 반복해서 칼립소 주법을 연주해 보세요.", audioFile: nil, delayAfter: nil, speechRate: nil)],
        featureDescription: "이전 학습으로 넘어가시려면 \"이전\", 다음 학습으로 넘어가시려면 \"다음\"을, 다시 들으시려면 \"다시\"를 말씀해 주세요."
      ),
      TechniqueLessonStep(
        step: 7,
        ...
        imageName: "",
        subSteps: [TechniqueLessonSubStep(ttsText: "주법 학습이 완료되었습니다. ", audioFile: nil, delayAfter: nil, speechRate: nil)],
